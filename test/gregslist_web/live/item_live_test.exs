defmodule GregslistWeb.ItemLiveTest do
  use GregslistWeb.ConnCase

  import Phoenix.LiveViewTest
  import Gregslist.GalleriesFixtures

  @create_attrs %{location: "some location", desc: "some desc", item_name: "some item_name", price: 120.5}
